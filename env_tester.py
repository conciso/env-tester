...
PRESETS_FILE        = "/opt/env-tester/presets.yml"   # eigenes Projektverzeichnis
LIGHTRAG_HOST       = "lightrag"               # Container-Name im aibox_network
LIGHTRAG_PORT       = 9621
EMBEDDING_HOST      = "vllm-qwen3-vl-embedding"  # Container-Name im aibox_network
EMBEDDING_PORT      = 9010
HEALTH_TIMEOUT      = 120
EMBED_TIMEOUT       = 600
